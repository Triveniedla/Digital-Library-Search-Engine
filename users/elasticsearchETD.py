    ...
    def singlequery(self,whattosearch):
        ...
        if totalquerycount==0:
            ...
            for arg in res["hits"]["hits"]:
                ...
                Authoremail = ["mailto:"+element.split()[-1] for idx, element in enumerate(emails) if "Author" in element]
                Advisoremail = ["mailto:"+element.split()[-1] for idx, element in enumerate(emails) if "Advisor" in element]
...
#------function for multi query using ES--------
    def multiquery(self,whattosearch,date1,date2):
        ...
        try:
            ...
            msg=0
            output=["Etdsearch document is not found in elasticsearch server"]
            return output,msg
...
#------function to index using ES--------
    def elasticsearchindex(self,whattoindex):
        ...
        self.es.index(index='etdsearch', doc_type='documents',id=max_id, body=storeindex)
